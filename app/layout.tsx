    ...
    <html lang="en">
      <body>
        ...
        <div className="mx-auto min-h-screen max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <header className="mb-8 flex flex-col gap-4 rounded-[2rem] border border-black/5 bg-white/70 px-5 py-4 shadow-card sm:flex-row sm:items-center sm:justify-between">
